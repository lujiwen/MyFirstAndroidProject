...
package com.seadee.degree.settting;
...
import com.seadee.degree.utility.ButtonBarHandler;;
/**
    ...
    public boolean startFragment(
        ...
        if (getActivity() instanceof PreferenceActivity) {
            ...
            preferenceActivity.startPreferencePanel(fragmentClass, extras,
                  /*R.string.lock_settings_picker_title*/R.string.app_name, null, caller, requestCode);
            return true;
        } else {
