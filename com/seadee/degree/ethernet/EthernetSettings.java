...
import com.seadee.library.receiver.NetworkStateReceiver;
...
public class EthernetSettings extends  SettingsPreferenceFragment implements
        ...
        DialogInterface.OnClickListener, DialogInterface.OnDismissListener,View.OnKeyListener
{
    ...
    public 	Preference mIpPreference;
    ...
    public void onResume() {
    	mIpPreference.setSummary(NetworkStateReceiver.getLocalIpAddress(this.getActivity()));
        super.onResume();
	...
	public boolean onPreferenceChange(Preference preference, Object newValue){
		Log.e("ethernet", "onPreferenceChange");
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen screen, Preference preference) {
		Log.e("ethernet", "onPreferenceTreeClick");
        if (preference == mEthConfigure && mSelected != null) {
			mDialog = new EthernetDialog(getActivity(), this, mSelected.getConfigure(), true);
			mDialog.setOnDismissListener(this);
			mDialog.show();
			mDialog.getmDns().setOnKeyListener(this);
			mDialog.getmGw().setOnKeyListener(this);
			mDialog.getmIpaddr().setOnKeyListener(this);
		    mDialog.getmMask().setOnKeyListener(this);			
		}
        return true;
    }
    ...
    private void handleEvent(Context context, Intent intent) {
        ...
        mIpPreference.setSummary(NetworkStateReceiver.getLocalIpAddress(context));
	...
	private class EthPreference extends Preference {
		...
		public void update() {
			...
			setSummary( context.getString(R.string.eth_mac_name)+ hwaddr + " -- " 
	...
	public boolean onKey(View arg0, int arg1, KeyEvent event ) {
		Log.e("Ethernet", "onkey");
		if(event.getKeyCode()==KeyEvent.KEYCODE_ENTER || event.getKeyCode()==108){
